...
class SpFuncService(spear.Service):
    ...
    #
    # The caller must ensure that arrays and uobject_shared_memory_handles remain valid until the function
    # actually executes, which may be after this function returns, e.g., if self.entry_point_caller is
    # asynchronous.
    #
