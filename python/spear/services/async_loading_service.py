...
class AsyncLoadingService(spear.Service):
    ...
    def is_engine_idle(self):
        ...
        engine_idle = not is_async_loading and not is_loading_assets and num_remaining_assets == 0 and num_remaining_build_tasks == 0 and not are_streaming_levels_loading

        spear.log(f"engine_idle={engine_idle} (is_async_loading={is_async_loading}, is_loading_assets={is_loading_assets}, num_remaining_assets={num_remaining_assets}, num_remaining_build_tasks={num_remaining_build_tasks}, are_streaming_levels_loading={are_streaming_levels_loading})")
