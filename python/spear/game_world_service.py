...
class GameWorldService():
    ...
    def new_object(self, class_name, outer, name="", object_flags=["RF_NoFlags"], template=0, copy_transients_from_class_defaults=False, in_instance_graph=0, external_package=0):
        return self._rpc_client.call("game_world_service.new_object", class_name, outer, name, template, copy_transients_from_class_defaults, in_instance_graph, external_package, {"ObjectFlags": object_flags})
