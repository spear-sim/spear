...
class Env(gym.Env):
    ...
    def _get_observation_space(self):
        array_desc = self._sp_engine.rpc_client.call("get_observation_space")
        assert len(array_desc) > 0
        return array_desc

    def _get_task_step_info_space(self):
        return self._sp_engine.rpc_client.call("get_task_step_info_space")

    def _get_agent_step_info_space(self):
        return self._sp_engine.rpc_client.call("get_agent_step_info_space")
    ...
    def _apply_action(self, action):
        ...
        self._sp_engine.rpc_client.call("apply_action", action_non_shared_serialized)

    def _get_observation(self):

        observation_shared = self._observation_space_desc.shared_memory_arrays

        observation_non_shared_serialized = self._sp_engine.rpc_client.call("get_observation")
    ...
    def _get_reward(self):
        return self._sp_engine.rpc_client.call("get_reward")
    
    def _is_episode_done(self):
        return self._sp_engine.rpc_client.call("is_episode_done")
    ...
    def _get_step_info(self):
        ...
        task_step_info_non_shared_serialized = self._sp_engine.rpc_client.call("get_task_step_info")
        agent_step_info_non_shared_serialized = self._sp_engine.rpc_client.call("get_agent_step_info")
    ...
    def _reset(self):
        ...
        self._sp_engine.rpc_client.call("reset_task")
        self._sp_engine.rpc_client.call("reset_agent")

    def _is_ready(self):
        return self._sp_engine.rpc_client.call("is_task_ready") and self._sp_engine.rpc_client.call("is_agent_ready")
