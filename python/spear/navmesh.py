...
class NavMesh():
    ...
    def _get_random_points(self, num_points):
        random_points = self.__simulation_controller.rpc_client.call("navmesh.get_random_points", num_points)
    ...
    def _get_random_reachable_points_in_radius(self, reference_points, search_radius):
        ...
        reachable_points = self.__simulation_controller.rpc_client.call("navmesh.get_random_reachable_points_in_radius", reference_points.flatten().tolist(), search_radius)
    ...
    def _get_paths(self, initial_points, goal_points):
        ...
        paths = self.__simulation_controller.rpc_client.call("navmesh.get_paths", initial_points.flatten().tolist(), goal_points.flatten().tolist())
