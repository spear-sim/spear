...
DEFAULT_CONFIG_FILES = [
    ...
    os.path.realpath(os.path.join(SPEAR_ROOT_DIR, "config", "default_config.openbot.yaml")), #TODO: remove this for final PR state
    os.path.realpath(os.path.join(SPEAR_ROOT_DIR, "config", "default_config.wheeled_vehicle.yaml")),
