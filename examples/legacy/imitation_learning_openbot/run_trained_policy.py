...
if __name__ == "__main__":
    ...
    config.SP_SERVICES.LEGACY.IMITATION_LEARNING_TASK.EPISODES_FILE = os.path.realpath(args.episodes_file)
    config.freeze()
    ...
    # load driving policy
    policy = policies.OpenBotPilotNetPolicy(config)
