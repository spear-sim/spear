...
class OpenBotPathFollowingPolicy():
    ...
    def step(self, obs):
        ...
        location_xy_speed  = np.linalg.norm(location_xy_current - location_xy_prev) / self._config.SP_SERVICES.LEGACY_SERVICE.PHYSICS.SIMULATION_STEP_TIME
        rotation_yaw_speed = np.linalg.norm(rotation_yaw_current - rotation_yaw_prev) / self._config.SP_SERVICES.LEGACY_SERVICE.PHYSICS.SIMULATION_STEP_TIME
