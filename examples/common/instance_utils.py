...
def open_level(instance, scene_id, map_id=""):
    ...
    gameplay_statics_default_object = instance.game_world_service.get_default_object(uclass=gameplay_statics_class)
    open_level_func = instance.game_world_service.find_function_by_name(uclass=gameplay_statics_class, name="OpenLevel")
