...
```console
python ../../tools/run_editor_script.py --unreal-engine-dir path/to/UE_5.7 --launch-mode full --render-offscreen --script /absolute/path/to/spear/examples/getting_started_editor/run.py --save-level
```
