...
```console
python ../../tools/run_editor_script.py --script /absolute/path/to/spear/examples/getting_started_editor/run.py --unreal-engine-dir path/to/UE_5.7 --launch-mode full --render-offscreen --save-level
```
