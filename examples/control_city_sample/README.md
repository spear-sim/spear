...
python ../../tools/run_uat.py --unreal-engine-dir path/to/UE_5.7 --unreal-project-dir path/to/CitySample -build
```
...
```console
python ../../run_editor.py --unreal-engine-dir path/to/UE_5.7 --unreal-project-dir path/to/CitySample --config-files user_config.yaml
```
