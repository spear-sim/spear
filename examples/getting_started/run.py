...
if __name__ == "__main__":
    ...
    with instance.begin_frame():
        ...
        bp_axes = instance.unreal_service.spawn_actor_from_uclass(uclass=bp_axes_uclass, location={"X": -10.0, "Y": 280.0, "Z": 50.0})

        spear.log("bp_axes: ")
        pprint.pprint(instance.unreal_service.get_object_properties_from_uobject(bp_axes))
        ...
        root_component_property_desc = instance.unreal_service.find_property_by_name_on_uobject(uobject=bp_axes, property_name="RootComponent")
