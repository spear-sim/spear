# Render an Image (in the Unreal Editor)
...
```console
python ../../tools/run_editor_script.py --unreal-engine-dir path/to/UE_5.7 --launch-mode full --render-offscreen --script /absolute/path/to/spear/examples/render_image_editor/run.py
```
