...
In a pre-processing step, we need to install the SPEAR plugins into the `HillsideSample` project. We must also build the project, which will build the SPEAR plugin binaries and copy them into the project directory.
