...
if __name__ == "__main__":
    ...
    with instance.begin_frame():
        ...
        bp_happy = game.unreal_service.spawn_actor(uclass=bp_happy_uclass, location={"X": 80.0, "Y": 280.0, "Z": 5.0})
        bp_dragon = game.unreal_service.spawn_actor(uclass=bp_dragon_uclass, location={"X": 80.0, "Y": 350.0, "Z": 5.0})
