...
In this example application, we demonstrate how to efficiently pass NumPy arrays to and from Unreal objects.
...
You should see a game window appear, with the contents of several NumPy arrays printed to the console.
