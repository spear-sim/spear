# Control the `GameAnimationSample` Project (for Unreal Engine 5.8)

In this example application, we demonstrate how to control the `GameAnimationSample` project (for Unreal Engine 5.8), which is a freely available sample project from Epic Games.
...
python ../../tools/run_uat.py --unreal-engine-dir path/to/UE_5.8 --unreal-project-dir path/to/GameAnimationSample -build
```
...
```console
python ../../run_editor.py --unreal-engine-dir path/to/UE_5.8 --unreal-project-dir path/to/GameAnimationSample --config-files user_config.yaml
```
