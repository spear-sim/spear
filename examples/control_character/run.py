...
if __name__ == "__main__":
    ...
    with instance.begin_frame():
        ...
        bp_third_person_class = instance.unreal_service.load_object(
            class_name="UObject", outer=0, name="/Game/ThirdPerson/Blueprints/BP_ThirdPersonCharacter.BP_ThirdPersonCharacter_C")
        bp_third_person_actor1 = instance.unreal_service.spawn_actor_from_uclass(
            uclass=bp_third_person_class,
        ...
        bp_third_person_actor2 = instance.unreal_service.spawn_actor_from_uclass(
            uclass=bp_third_person_class,
            location={"X": 0.0, "Y": 200.0, "Z": 150.0},
            rotation={"Roll": 0.0, "Pitch": 0.0, "Yaw": 0.0},
        ...
        skeletal_mesh_component_num_bones1 = instance.unreal_service.call_function(
            uobject=skeletal_mesh_component1,
            ufunction=get_num_bones_func)['ReturnValue']
