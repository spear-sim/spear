...
if __name__ == "__main__":
    ...
    with instance.begin_frame():
        ...
        # set_steering_input_func = instance.unreal_service.find_function_by_name(uclass=chaos_vehicle_movement_component_static_class, function_name="SetSteeringInput")
        # set_throttle_input_func = instance.unreal_service.find_function_by_name(uclass=chaos_vehicle_movement_component_static_class, function_name="SetThrottleInput")
        #
        # chaos_vehicle_movement_component = instance.unreal_service.get_component_by_class(actor=car, uclass=chaos_vehicle_movement_component_static_class)
        #
    ...
    with instance.begin_frame():
        ...
        # If we wanted to control the car by calling its UFUNCTIONS directly, we could do so as follows:
        #
        # instance.unreal_service.call_function(uobject=chaos_vehicle_movement_component, ufunction=set_steering_input_func, args={"Steering": 1.0})
        #
