...
if __name__ == "__main__":
    ...
    with instance.begin_frame():
        ...
        return_values = instance.unreal_service.call_function(
            uobject=gameplay_statics_default_object, ufunction=get_player_controller_func, args={"PlayerIndex": 0})
        player_controller = spear.to_handle(return_values["ReturnValue"])

        bp_car_uclass = instance.unreal_service.load_object(
            class_name="UObject", outer=0, name="/Game/VehicleTemplate/Blueprints/OffroadCar/OffroadCar_Pawn.OffroadCar_Pawn_C")
        bp_car_actor = instance.unreal_service.spawn_actor_from_uclass(
            uclass=bp_car_uclass,
            location={"X": 0.0, "Y": 0.0, "Z": 0.0},
            rotation={"Roll": 0.0, "Pitch": 0.0, "Yaw": 0.0},
            spawn_parameters={"Name": "Agent", "SpawnCollisionHandlingOverride": "AlwaysSpawn"})

        vehicle_movement_component = instance.unreal_service.get_component_by_class(actor=bp_car_actor, uclass=chaos_vehicle_movement_component_uclass)
        ...
        instance.unreal_service.call_function(
            ...
            args={"InPawn": spear.to_ptr(bp_car_actor)})
