...
if __name__ == "__main__":
    ...
    editor.python_service.execute_file_across_frames(file=inner_script_across_frames_file, args_string="--num-yields 3 --scale 4.0", execution_scope="Public")
    with instance.begin_frame():
        result = editor.python_service.get(name="across_frames_result")
    ...
    editor.python_service.execute_file_across_frames(file=inner_script_file, args_string="--scale 3.0", execution_scope="Public")
    with instance.begin_frame():
        result = editor.python_service.get(name="inner_script_result")
        spear.log("Expecting np.ndarray:   ", type(result), " ", result)
    ...
    try:
        editor.python_service.execute_file_across_frames(file=inner_script_raise_file, args_string="")
    ...
    with instance.begin_frame():
        ...
        editor.python_service.set(name="test_int", value=42)
        result = editor.python_service.get(name="test_int")
        spear.log("Expecting int:          ", type(result), " ", result)
        assert result == 42

        editor.python_service.set(name="test_array", value=np.array([1.0, 2.0, 3.0]))
        result = editor.python_service.get(name="test_array")
        spear.log("Expecting np.ndarray:   ", type(result), " ", result)
        ...
        editor.python_service.execute_file(file=inner_script_file, args_string="--scale 5.0", execution_scope="Public")
        result = editor.python_service.get(name="inner_script_result")
        spear.log("Expecting np.ndarray:   ", type(result), " ", result)
        ...
        editor.python_service.execute_statement(statement="test_stmt_var = 123")
        result = editor.python_service.evaluate_expression(expression="test_stmt_var", execution_scope="Public")
        spear.log("Expecting int:          ", type(result), " ", result)
        assert result == 123
        ...
        result = editor.python_service.evaluate_expression(expression="1 + 1")
        spear.log("Expecting int:          ", type(result), " ", result)
        assert result == 2

        result = editor.python_service.evaluate_expression(expression="3.14")
        spear.log("Expecting float:        ", type(result), " ", result)
        assert result == 3.14

        result = editor.python_service.evaluate_expression(expression="True")
        spear.log("Expecting bool:         ", type(result), " ", result)
        assert result is True

        result = editor.python_service.evaluate_expression(expression="'hello world'")
        spear.log("Expecting str:          ", type(result), " ", result)
        assert result == "hello world"

        result = editor.python_service.evaluate_expression(expression="None")
        spear.log("Expecting None:         ", type(result), " ", result)
        assert result is None

        # evaluate numpy arrays and matrices
        result = editor.python_service.evaluate_expression(expression="np.arange(10, dtype=np.float64).reshape(2, 5)")
        ...
        result = editor.python_service.evaluate_expression(expression="np.matrix([[1.0, 2.0], [3.0, 4.0]])")
        ...
        result = editor.python_service.evaluate_expression(expression="{'array': np.arange(4, dtype=np.float64), 'count': 2}")
        spear.log("Expecting dict:         ", type(result), " ", result)
        np.testing.assert_array_equal(result["array"], np.arange(4, dtype=np.float64))
        assert result["count"] == 2

        result = editor.python_service.evaluate_expression(expression="[1, 'hello', np.array([10, 20, 30])]")
        ...
        result = editor.python_service.evaluate_expression(expression="unreal.Vector(x=1.0, y=2.0, z=3.0)")
        spear.log("Expecting dict:         ", type(result), " ", result)
        ...
        result = editor.python_service.evaluate_expression(expression="spear.editor.find_actors()[0]")
        ...
        result = editor.python_service.evaluate_expression(expression="spear.editor.find_actors()[0]", as_handle=True)
        spear.log("Expecting int:          ", type(result), " ", result)
        ...
        result = editor.python_service.evaluate_expression(expression=f"{spear.to_script_expr(obj=arr)}*2")
        spear.log("Expecting np.ndarray:   ", type(result), " ", result)
