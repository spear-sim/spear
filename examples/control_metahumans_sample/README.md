...
python ../../tools/run_uat.py --unreal-engine-dir path/to/UE_5.7 --unreal-project-dir path/to/MetaHumans -build
```
...
```console
python ../../run_editor.py --unreal-engine-dir path/to/UE_5.7 --unreal-project-dir path/to/MetaHumans
```
