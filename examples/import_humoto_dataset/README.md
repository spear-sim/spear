...
```console
# import humoto dataset
python ../../tools/run_editor_script.py --unreal-engine-dir path/to/UE_5.7 --launch-mode full --render-offscreen --script /absolute/path/to/spear/examples/import_animation_dataset/import_dataset.py --filesystem-base-dir /absolute/path/to/humoto_dataset --content-base-dir /Game/Humoto
```
