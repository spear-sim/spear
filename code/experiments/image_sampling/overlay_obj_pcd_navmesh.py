...
if __name__ == "__main__":
    ...
    if args.obj_file is None:
        ...
        assert args.save_as_hdf5 == True, "input hdf5_dir param to save as hdf5 files"
        # load obj file
        ...
        with h5py.File(os.path.join(args.hdf5_dir, "vertices.hdf5"),  "w") as f: f.create_dataset("dataset", data=isim_obj_file.vertices)
        with h5py.File(os.path.join(args.hdf5_dir, "faces_oi.hdf5"),  "w") as f: f.create_dataset("dataset", data=isim_obj_file.faces_oi)
        with h5py.File(os.path.join(args.hdf5_dir, "faces_vi.hdf5"),  "w") as f: f.create_dataset("dataset", data=isim_obj_file.faces_vi)
