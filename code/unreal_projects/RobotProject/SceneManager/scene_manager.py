...
def print_help():
    print('scene_manager.py -i <option> -v <version> -d <option is_download_ddc> -f <option is_force_upadte>\ne.g:scene_manager.py -v v1')
    sys.exit(2)
...
if __name__ == '__main__':
    ...
    if version == '':
            print('set version correct. please select version form SceneManage/Data/dataset-repo-update.log')
            print_help()
