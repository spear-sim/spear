...
{
    this->createVehicleApi(static_cast<ASimpleVehiclePawn*>(params.vehicle->GetPawn()), params.home_geopoint);
}
...
void SimpleVehicleSimApi::createVehicleApi(ASimpleVehiclePawn* pawn, const RobotSim::GeoPoint& home_geopoint)
{
    this->vehicle_api_ = std::unique_ptr<SimpleVehicleApi>(new SimpleVehicleApi());
}
