...
void ACameraDirector::Tick(float DeltaTime)
{
    ...
    if (mode_ == ECameraDirectorMode::CAMERA_DIRECTOR_MODE_MANUAL) {
        ...
        URobotBlueprintLib::FollowActor(ExternalCamera, follow_actor_, initial_ground_obs_offset_, ext_obs_fixed_z_);
    }
}
...
void ACameraDirector::setMode(ECameraDirectorMode mode)
{
    ...
    {   //perform any settings to enter in to this mode
        ...
        case ECameraDirectorMode::CAMERA_DIRECTOR_MODE_NODISPLAY:
            URobotBlueprintLib::enableViewportRendering(this, false); break;
        default:
...
void ACameraDirector::setupInputBindings()
{
    ...
    //URobotBlueprintLib::BindActionToKey("inputEventFpvView", EKeys::F, this, &ACameraDirector::inputEventFpvView);
    //URobotBlueprintLib::BindActionToKey("inputEventFlyWithView", EKeys::B, this, &ACameraDirector::inputEventFlyWithView);
    //URobotBlueprintLib::BindActionToKey("inputEventGroundView", EKeys::Backslash, this, &ACameraDirector::inputEventGroundView);
    //URobotBlueprintLib::BindActionToKey("inputEventManualView", EKeys::M, this, &ACameraDirector::inputEventManualView);
    //URobotBlueprintLib::BindActionToKey("inputEventSpringArmChaseView", EKeys::Slash, this, &ACameraDirector::inputEventSpringArmChaseView);
    //URobotBlueprintLib::BindActionToKey("inputEventBackupView", EKeys::K, this, &ACameraDirector::inputEventBackupView);
    //URobotBlueprintLib::BindActionToKey("inputEventNoDisplayView", EKeys::Hyphen, this, &ACameraDirector::inputEventNoDisplayView);
    //URobotBlueprintLib::BindActionToKey("inputEventFrontView", EKeys::I, this, &ACameraDirector::inputEventFrontView);
}
...
void ACameraDirector::inputEventSpringArmChaseView()
{
    if (ExternalCamera) {
        ...
        URobotBlueprintLib::LogMessageString("Camera is not available: ", "ExternalCamera", LogDebugLevel::Failure);
}
...
void ACameraDirector::inputEventBackupView()
{
    if (backup_camera_) {
        ...
        URobotBlueprintLib::LogMessageString("Camera is not available: ", "backup_camera", LogDebugLevel::Failure);
}
...
void ACameraDirector::inputEventFpvView()
{
    if (fpv_camera_) {
        ...
        URobotBlueprintLib::LogMessageString("Camera is not available: ", "fpv_camera", LogDebugLevel::Failure);
}
