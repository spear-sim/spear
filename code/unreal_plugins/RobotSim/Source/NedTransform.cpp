...
NedTransform::NedTransform(const FTransform& global_transform, float world_to_meters) : NedTransform(nullptr, global_transform, world_to_meters)
{
}
NedTransform::NedTransform(const AActor* pivot, const NedTransform& global_transform) : NedTransform(pivot, global_transform.global_transform_, global_transform.world_to_meters_)
{
}

NedTransform::NedTransform(const AActor* pivot, const FTransform& global_transform, float world_to_meters) : global_transform_(global_transform), world_to_meters_(world_to_meters)
{
    if (pivot != nullptr) {
