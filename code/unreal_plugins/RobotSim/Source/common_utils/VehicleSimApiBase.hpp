...
class VehicleSimApiBase : public RobotSim::UpdatableObject {
public:
    ...
    virtual const RobotSim::Environment* getGroundTruthEnvironment() const = 0;
    ...
    virtual RobotSim::RayCastResponse rayCast(const RobotSim::RayCastRequest& request) = 0;
   ...
   // virtual RCData getRCData() const = 0; //get reading from RC from simulator's host OS
    ...
    virtual void setDrawShapes(std::unordered_map<std::string, RobotSim::DrawableShape> &drawableShapes, bool persist_unmentioned) = 0;
