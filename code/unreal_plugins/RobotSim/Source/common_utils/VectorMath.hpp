...
// This #ifdef logic works around an issue where the -Wimplicit-int-float-conversion warning/error is unknown
// to Clang 11, despite appearing in the documentation. Eigen attempts to explicitly disable this warning/error,
// which causes its own "unknown warning group" warning/error. We work around this issue by explicitly
// disabling the "unknown warning group" warning/error.
