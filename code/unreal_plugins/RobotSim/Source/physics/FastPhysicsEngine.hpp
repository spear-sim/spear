...
#include "common_utils/SteppableClock.hpp"
...
namespace RobotSim {
    ...
    public:
        ...
        /**
         * @brief Construct a new Fast Physics Engine object
         * 
         * @param enable_ground_lock 
         */
    ...
    private:
         ...
         * @param next
         * @param is_collision_response
         * @param collision_response
         */
        ...
        /**
         * @brief Return value indicates if collision response was generated
         *
         * @param dt
         * @param collision_info
         * @param body
                                                 ...
                                                 const Kinematics::State& current, Kinematics::State& next, Wrench& next_wrench, bool enable_ground_lock)
        {
            ...
            /*
                ...
                V(t+1) = V(t) + j*N / m
            */
            const real_T impulse_mag_denom = 1.0f / body.getMass() + (body.getInertiaInv() * r.cross(normal_body)).cross(r).dot(normal_body);
            ...
            // Above would modify component in direction of normal. We will use friction to modify component in direction of tangent.
            ...
            const real_T friction_mag_denom = 1.0f / body.getMass() + (body.getInertiaInv() * r.cross(contact_tang_unit_body)).cross(r).dot(contact_tang_unit_body);
            ...
            if (enable_ground_lock && ground_collision) {
                ...
                // But we do want to "feel" the ground when we hit it (we should see a small z-acc bump) equal and opposite our downward velocity.
        ...
        /**
         * @brief add linear drag due to velocity we had since last dt seconds
        ...
        static void computeNextPose(TTimeDelta dt, const Pose& current_pose, const Vector3r& avg_linear, const Vector3r& avg_angular, Kinematics::State& next)
        {
            ...
            if (Utils::isDefinitelyGreaterThan(angle_per_unit, 0.0f)) {
                ...
                //
                // which simplifies to q0(q1(v)q1')q0'
                //
