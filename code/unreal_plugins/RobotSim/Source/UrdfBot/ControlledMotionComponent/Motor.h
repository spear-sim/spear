...
public:
    ...
    virtual void
    Attach(AUrdfLink* baseLink,
           AUrdfLink* actuationLink,
           UrdfJointSpecification* jointSpecification,
           UPhysicsConstraintComponent* constraintComponent) override;
    /*
    ...
    */
    ...
    virtual void
    ControlAbsoluteJointPose(TMap<FString, float> controlSignals) override;
    virtual void
    ControlRelativeJointPose(TMap<FString, float> controlSignals) override;
    virtual TMap<FString, FString> GetState() override;
    virtual ControlledMotionComponent::MotionComponentType
    GetMotionType() override;
    ...
    // target velocity control, currently only valid for continuous joint. TODO
    // implement this to all joint type?
...
private:
    ...
    bool bUseTargetControl = true; // whether use target control directly and
                                   // override control signal control
};