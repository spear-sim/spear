...
AUrdfBotPawn::AUrdfBotPawn()
{
    ...
    mPhysicsHandle = CreateDefaultSubobject<UPhysicsHandleComponent>(FName("PhysicsHandleComponent"));
    ...
    try
    {
        RobotSimSettings& settings = RobotSimSettings::RobotSimSettings::singleton();
...
void AUrdfBotPawn::InitializeForBeginPlay()
{
    ...
    this->draw_debug_ = !RobotSim::Utils::isApproximatelyZero(this->debug_symbol_scale_);
	...
	if (urdf_path.substr(urdf_path.length() - 4, urdf_path.length()) == std::string(".xml"))
	{
		//import ik library using urdf file path instead of urdf
		this->inverseKinematicComponent->ImportModel(urdf_path.substr(0, urdf_path.length() - 4) + ".urdf", this->scale_factor_);
	}
	else
	{
        //TODO use .urdf file directly? 
		this->inverseKinematicComponent->ImportModel(urdf_path, this->scale_factor_);
	};

	FString endEffectorName = settings.pawn_paths["UrdfBot"].end_effector_link.c_str();
...
TMap<FString, ControlledMotionComponent*> AUrdfBotPawn::GetBotMotionComponents() const
{
...
void AUrdfBotPawn::TeleportToLocation(FVector position, FQuat orientation, bool teleport)
{
	...
	RobotSimVehicle::TeleportToLocation(position * URobotBlueprintLib::GetWorldToMetersScale(this), orientation, teleport);
}
...
void AUrdfBotPawn::setupInputBindings()
{
	...
	URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("onBaseMove", EKeys::W, val), this, this, &AUrdfBotPawn::onBaseMove);
	URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("onBaseMove", EKeys::S, -val), this, this, &AUrdfBotPawn::onBaseMove);
	URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("onBaseRotate", EKeys::A, rotVal), this, this, &AUrdfBotPawn::onBaseRotate);
	URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("onBaseRotate", EKeys::D, -rotVal), this, this, &AUrdfBotPawn::onBaseRotate);

	URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("onBaseMove", EKeys::Up, val), this, this, &AUrdfBotPawn::onBaseMove);
	URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("onBaseMove", EKeys::Down, -val), this, this, &AUrdfBotPawn::onBaseMove);
	URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("onBaseRotate", EKeys::Left, rotVal), this, this, &AUrdfBotPawn::onBaseRotate);
	URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("onBaseRotate", EKeys::Right, -rotVal), this, this, &AUrdfBotPawn::onBaseRotate);

	// keyboard binding to move prismatic joint 
	URobotBlueprintLib::BindActionToKey("onStiffnessUp", EKeys::E, this, &AUrdfBotPawn::onStiffnessUp, true);
	URobotBlueprintLib::BindActionToKey("onStiffnessDown", EKeys::Q, this, &AUrdfBotPawn::onStiffnessDown, true);


	URobotBlueprintLib::BindActionToKey("onTorsoUp", EKeys::T, this, &AUrdfBotPawn::onTorsoUp, true);
	URobotBlueprintLib::BindActionToKey("onTorsoDown", EKeys::G, this, &AUrdfBotPawn::onTorsoDown, true);

	URobotBlueprintLib::BindActionToKey("onArmXUp", EKeys::I, this, &AUrdfBotPawn::onArmXUp, true);
	URobotBlueprintLib::BindActionToKey("onArmXDown", EKeys::K, this, &AUrdfBotPawn::onArmXDown, true);

	URobotBlueprintLib::BindActionToKey("onArmYUp", EKeys::L, this, &AUrdfBotPawn::onArmYUp, true);
	URobotBlueprintLib::BindActionToKey("onArmYDown", EKeys::J, this, &AUrdfBotPawn::onArmYDown, true);

	URobotBlueprintLib::BindActionToKey("onArmZUp", EKeys::Y, this, &AUrdfBotPawn::onArmZUp, true);
	URobotBlueprintLib::BindActionToKey("onArmZDown", EKeys::H, this, &AUrdfBotPawn::onArmZDown, true);

	URobotBlueprintLib::BindActionToKey("onArmXRotationUp", EKeys::Z, this, &AUrdfBotPawn::onArmXRotationUp, true);
	URobotBlueprintLib::BindActionToKey("onArmXRotationDown", EKeys::C, this, &AUrdfBotPawn::onArmXRotationDown, true);

	URobotBlueprintLib::BindActionToKey("onArmYRotationUp", EKeys::V, this, &AUrdfBotPawn::onArmYRotationUp, true);
	URobotBlueprintLib::BindActionToKey("onArmYRotationDown", EKeys::B, this, &AUrdfBotPawn::onArmYRotationDown, true);

	URobotBlueprintLib::BindActionToKey("onArmZRotationUp", EKeys::N, this, &AUrdfBotPawn::onArmZRotationUp, true);
	URobotBlueprintLib::BindActionToKey("onArmZRotationDown", EKeys::M, this, &AUrdfBotPawn::onArmZRotationDown, true);

	URobotBlueprintLib::BindActionToKey("onArmReset", EKeys::R, this, &AUrdfBotPawn::onArmReset, true);
	URobotBlueprintLib::BindActionToKey("onTest", EKeys::F, this, &AUrdfBotPawn::onTest, true);

	URobotBlueprintLib::BindActionToKey("onManipulator", EKeys::SpaceBar, this, &AUrdfBotPawn::onManipulator, true);

	////运动控制绑定
	//URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("MoveForward", EKeys::Up, 0.2), this,
	//	this, &AUrdfBotPawn::onMoveForward);

	//URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("MoveForward", EKeys::Down, 0.0), this,
	//	this, &AUrdfBotPawn::onMoveForward);

	//URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("MoveRight", EKeys::Right, 0.5), this,
	//	this, &AUrdfBotPawn::onMoveRight);

	//URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("MoveRight", EKeys::Left, -0.5), this,
	//	this, &AUrdfBotPawn::onMoveRight);

	//URobotBlueprintLib::BindActionToKey("CatchObject", EKeys::U , this, &AUrdfBotPawn::onGrabObject, true);
	//URobotBlueprintLib::BindActionToKey("Handbrake", EKeys::End, this, &AUrdfBotPawn::onDropReleased, false);

	//URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("Footbrake", EKeys::SpaceBar, 1), this,
	//	this, &AUrdfBotPawn::onFootBrake);

	//URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("MoveRight", EKeys::Gamepad_LeftX, 1), this,
	//	this, &AUrdfBotPawn::onMoveRight);

	//URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("MoveForward", EKeys::Gamepad_RightTriggerAxis, 1), this,
	//	this, &AUrdfBotPawn::onMoveForward);

	//URobotBlueprintLib::BindAxisToKey(FInputAxisKeyMapping("Footbrake", EKeys::Gamepad_LeftTriggerAxis, 1), this,
	//	this, &AUrdfBotPawn::onFootBrake);
}
...
void AUrdfBotPawn::onMoveForward(float Val)
{
	...
	GEngine->AddOnScreenDebugMessage(0, 1.0f, FColor::Red, *FString::SanitizeFloat(Val));
	for (auto& componentName : components)
	{
		if (controlled_motion_components_.Contains(componentName))
		{
			ControlledMotionComponent* component = controlled_motion_components_[componentName];
...
{
	FTransform result = getRelativePose(FString("base_link"), FString("gripper_link"));
	URobotBlueprintLib::LogMessage(FString("gripper_link actual: \n"), *result.ToHumanReadableString(), LogDebugLevel::Informational, 30);

	if (!mIsClawGrabbed && mOtherHitComponent)
	{
		this->mPhysicsHandle->GrabComponentAtLocation(mOtherHitComponent, FName(), this->mHitPoint);
		mIsClawGrabbed = true;
	}
	else
	{
...
bool AUrdfBotPawn::InitializeForCatchObject()
{
	if (this->mEndEffectorLink)
	{
		...
		UStaticMeshComponent* rootMesh = static_cast<UStaticMeshComponent*>(this->mEndEffectorLink->GetRootMesh());
		rootMesh->OnComponentHit.AddDynamic(this, &AUrdfBotPawn::OnEndEffectorCollision);
	}

	return true;
}

void AUrdfBotPawn::OnEndEffectorCollision(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	if (OtherActor->GetName() != FString("UrdfBot"))
	{
		GEngine->AddOnScreenDebugMessage(1, 8.f, FColor::Red, TEXT("please press 'U' to catch object"));
		URobotBlueprintLib::LogMessage(FString("OnClawCollision"), *OtherActor->GetName(), LogDebugLevel::Failure, 30);
		...
		if (hitActor && hitActor->GetRootComponent())
		{
			...
			//UPrimitiveComponent*  targetHit = static_cast<UPrimitiveComponent*>(hitActor->GetRootComponent());
			//mPhysicsHandle->GrabComponentAtLocation(targetHit, FName(), Hit.Location);
		}
	}
}

TMap<FString, TTuple<UrdfJointType, UPhysicsConstraintComponent*>> AUrdfBotPawn::getConstraints()
{
	return this->constraints_;
}

void AUrdfBotPawn::setLinkForceAndTorque(FString componentName, const FVector& force, const FVector& torque)
{
	//get link
...
void AUrdfBotPawn::setJointTorque(FString jointName, const FVector& torque)
{
	...
	{
		ControlledMotionComponent*  jointComponent = this->controlled_motion_components_[jointName];
		jointComponent->SetConstTorque(torque); // jointComponent指针必然不为空，所以不需要做判空处理。
		...
		//UPhysicsConstraintComponent*  phyXcomponent = jointComponent->GetConstraintComponent();
		//float damping0 = phyXcomponent->ConstraintInstance.ProfileInstance.LinearDrive.XDrive.Damping;
		//float damping1 = phyXcomponent->ConstraintInstance.ProfileInstance.AngularDrive.TwistDrive.Damping;
		...
		//		break;
		//	//ToDo other list
		//	case ControlledMotionComponent::MotionComponentType::LINERACTUATOR:
		//		phyXcomponent->SetAngularVelocityTarget(torque);
		//		break;
		//	default:
		//		break;
...
AUrdfLink* AUrdfBotPawn::GetLink(FString linkName)
{
    ...
    {
		UE_LOG(LogTemp, Warning, TEXT("Requested component named %s in GetComponent(), which does not exist. "), *linkName);
...
void AUrdfBotPawn::ConstructFromFile(FString fileName)
{
    ...
    {
        rootCollisionComponent->SetWorldLocationAndRotation(rootLocation, rootRotation);
    }
...
AUrdfLink* AUrdfBotPawn::CreateLinkFromSpecification(const UrdfLinkSpecification &linkSpecification)
{
	...
	bool createResult = this->staticMeshGenerator_.CreateUnscaledMeshForLink(linkSpecification, visualGeometry, collisionGeometry, this, link, this->materials_);
	if (createResult)
	{
...
void AUrdfBotPawn::AttachChildren(AUrdfLink* parentLink, const UrdfLinkSpecification &parentLinkSpecification, AUrdfLink *childLink, const UrdfLinkSpecification &childLinkSpecification, UrdfJointSpecification *jointSpecification)
{
	...
	FTransform world2BaseTransform(parentReferenceRotation, parentReferenceTranslation, FVector(1., 1., 1.));
	FVector referenceTranslation = world2BaseTransform.TransformPosition(jointSpecification->Origin.Origin * Scalefactor* this->world_scale_);
	FRotator referenceRotation = world2BaseTransform.TransformRotation(FMath::RadiansToDegrees(jointSpecification->Origin.RollPitchYaw).Quaternion()).Rotator();
	//FVector referenceTranslation = parentReferenceTranslation + parentReferenceRotation.RotateVector(jointSpecification->Origin.Origin * Scalefactor) * this->world_scale_;
    ...
    if (childCollisionComponent != nullptr)
    {
        ...
        {
			FVector localPos = (jointSpecification->Origin.Origin + childLinkSpecification.CollisionSpecification->Origin.Origin) * Scalefactor * this->world_scale_;
			FRotator localOri = FMath::RadiansToDegrees(jointSpecification->Origin.RollPitchYaw) + FMath::RadiansToDegrees(childLinkSpecification.CollisionSpecification->Origin.RollPitchYaw);
			
			childCollisionComponent->SetWorldLocationAndRotation(world2BaseTransform.TransformPosition(localPos), world2BaseTransform.TransformRotation(localOri.Quaternion()).Rotator());
        }
        else
        {
	...
	if (childLinkSpecification.VisualSpecification != nullptr)
	{
		...
		FVector visualOffsetVector = visualOffsetRotator.RotateVector(childLinkSpecification.VisualSpecification->Origin.Origin * Scalefactor) * this->world_scale_;

		FVector localPos = (jointSpecification->Origin.Origin + childLinkSpecification.VisualSpecification->Origin.Origin) * Scalefactor * this->world_scale_;
		FRotator localOri = FMath::RadiansToDegrees(jointSpecification->Origin.RollPitchYaw) + FMath::RadiansToDegrees(childLinkSpecification.VisualSpecification->Origin.RollPitchYaw);

		childLink->SetActorLocationAndRotation(world2BaseTransform.TransformPosition(localPos), world2BaseTransform.TransformRotation(localOri.Quaternion()).Rotator());
    ...
    if (jointSpecification->Type != FIXED_TYPE)
    {
        ...
        FRotator jointAxisRotator(FMath::RadiansToDegrees(jointSpecification->RollPitchYaw));
        ...
        constraint->SetWorldRotation(rotation1, false, nullptr, ETeleportType::TeleportPhysics);
    }
	...
	//constraint->AttachToComponent(this->GetRootComponent(), FAttachmentTransformRules(EAttachmentRule::KeepWorld, (jointSpecification->Type == FIXED_TYPE)));
	//parentLink->GetRootMesh()->AttachToComponent(constraint, FAttachmentTransformRules(EAttachmentRule::KeepWorld, (jointSpecification->Type == FIXED_TYPE)));
	//childLink->GetRootMesh()->AttachToComponent(constraint, FAttachmentTransformRules(EAttachmentRule::KeepWorld, (jointSpecification->Type == FIXED_TYPE)));
    ...
    if (this->ConstraintNeedsControlledMotionComponent(*jointSpecification))
    {
		...
		if (jointSpecification->Type == CONTINUOUS_TYPE && jointSpecification->Limit)
		{
...
FConstraintInstance AUrdfBotPawn::CreateConstraint(const UrdfJointSpecification &jointSpecification)
{
    ...
    case REVOLUTE_TYPE:
        ...
        if (jointSpecification.Limit != nullptr && jointSpecification.Limit->Effort > 0)
        {
            ...
            constraintInstance.SetAngularDriveParams(jointSpecification.Limit->Effort * this->world_scale_ , 5.0f, jointSpecification.Limit->Effort * this->world_scale_ );
        }
        else
        {
    ...
    case CONTINUOUS_TYPE:
        ...
        if (jointSpecification.Limit != nullptr && jointSpecification.Limit->Effort > 0)
        {
		    ...
		    // UE_LOG(LogTemp, Warning, TEXT("this->world_scale_: %s "), this->world_scale_);
...
void AUrdfBotPawn::DrawDebug()
{
    ...
    for (auto& kvp : this->constraints_)
    {
        ...
        else if (jointType == PRISMATIC_TYPE)
        {
			...
			DrawDebugBox(world, componentLocation, FVector(2.5, 10, 10), componentRotation.Quaternion(), FColor::Red, persistant, persistSeconds, priority, thickness / 2);
...
void AUrdfBotPawn::onStiffnessUp()
{
	for (const auto& kvp : this->controlled_motion_components_)
	{
		...
		URobotBlueprintLib::LogMessage(kvp.Key, FString("stiffness=") + FString::SanitizeFloat(stiffness) + FString(" damping=") + FString::SanitizeFloat(damping), LogDebugLevel::Informational, 30);
	}
}
...
void AUrdfBotPawn::onBaseMove(float value)
{
	...
	Motor* leftComponent = static_cast<Motor*>(this->controlled_motion_components_["r_wheel_joint"]);
	Motor* rightComponent = static_cast<Motor*>(this->controlled_motion_components_["l_wheel_joint"]);
	FVector leftTarget = leftComponent->GetConstraintComponent()->ConstraintInstance.ProfileInstance.AngularDrive.AngularVelocityTarget;
	FVector rightTarget = rightComponent->GetConstraintComponent()->ConstraintInstance.ProfileInstance.AngularDrive.AngularVelocityTarget;

	float averageTargetVelocity = 0.5 * (leftTarget.X + rightTarget.X);
	float averageActualVelocity = 0.5 / (2 * PI) * (leftComponent->GetMotionSpeed() + rightComponent->GetMotionSpeed());
	...
	{
		if (leftComponent->GetConstraintComponent()->ConstraintInstance.ProfileInstance.AngularDrive.IsVelocityDriveEnabled())
		{
			// update baesd on previous target
			leftComponent->SetDriveTargetVelocity(averageTargetVelocity + value);
			rightComponent->SetDriveTargetVelocity(averageTargetVelocity + value);
		}
		else
		{
			// update baesd on current velocity
			leftComponent->EnableDrive(true);
			leftComponent->SetDriveTargetVelocity(averageActualVelocity + value);

			rightComponent->EnableDrive(true);
			rightComponent->SetDriveTargetVelocity(averageActualVelocity + value);
		}
	}
}
...
{
	Motor* jointComponent = static_cast<Motor*>(this->controlled_motion_components_[jointName]);
	if (target == 0)
	{
		// stop both wheel
	...
	else
	{
		...
		UPhysicsConstraintComponent* constraintComponent = jointComponent->GetConstraintComponent();
		FVector currentTarget = constraintComponent->ConstraintInstance.ProfileInstance.AngularDrive.AngularVelocityTarget;
...
{
	ControlledMotionComponent* jointComponent = this->controlled_motion_components_["torso_lift_joint"];
...
void AUrdfBotPawn::onTest()
{
	for (auto& kvp : this->components_)
	{
		if (kvp.Key != "base_link")
		{
			...
			if (mesh_root->IsGravityEnabled())
			{
				...
				URobotBlueprintLib::LogMessage(FString(kvp.Value->linkName_), FString(" false"), LogDebugLevel::Informational, 30);
			}
			else
			{
				mesh_root->SetEnableGravity(true);
				URobotBlueprintLib::LogMessage(FString(kvp.Value->linkName_), FString(" true"), LogDebugLevel::Informational, 30);
			}
	...
	//set to its current position. error might exist due to gravity? TODO double check on this
	//FVector deltaPos(0.0, 0.0, 0.0);
	//FVector deltaOri(0.0, 0.0, 0.0);
	//KeyBoardControl(deltaPos, deltaOri);
}

void AUrdfBotPawn::onManipulator()
{
	float val = 1;
	float before = this->controlled_motion_components_["r_gripper_finger_joint"]->GetDriveTarget();
	if (before <= 0)
	{
		val = 1;
	}
	...
	this->controlled_motion_components_["r_gripper_finger_joint"]->SetDriveTarget(val);
	this->controlled_motion_components_["l_gripper_finger_joint"]->SetDriveTarget(val);
}

void AUrdfBotPawn::KeyBoardControl(FVector deltaPos, FVector deltaOri)
{
	TMap<FString, float> Qinit = this->GetTargetQPosByLinkName();
	FTransform currentPose = getRelativePose(FString("base_link"), this->mEndEffectorName);
	FVector target_pos = currentPose.GetTranslation() + deltaPos;
	FQuat target_ori = FQuat::MakeFromEuler(currentPose.GetRotation().Euler() + 100 * deltaOri);
	FTransform temp(target_ori, target_pos, FVector(1.0, 1.0, 1.0));
	URobotBlueprintLib::LogMessage(FString("gripper_link target"), *temp.ToHumanReadableString(), LogDebugLevel::Informational, 30);

	TMap<FString, float> resultMap;
	bool flag = this->inverseKinematicComponent->CalculateIK(Qinit, this->mEndEffectorName, target_pos, target_ori, resultMap);
	if (flag)
	{
	...
	{
		URobotBlueprintLib::LogMessage(FString("unreachable position?"), target_pos.ToString() + FString("\n") + target_ori.Euler().ToString(), LogDebugLevel::Failure, 30);
	}
}
...
{
	ControlledMotionComponent* jointComponent = this->controlled_motion_components_[jointName];
	const FTransform& World2Parent = jointComponent->GetParentLink()->GetTransform();
	AUrdfLink* childLink = jointComponent->GetActuatorLink();

	FVector parent2childPos = World2Parent.InverseTransformPosition(childLink->GetActorLocation());
	FQuat parent2childOri = World2Parent.InverseTransformRotation(childLink->GetActorRotation().Quaternion());

	return FTransform(parent2childOri, parent2childPos / this->world_scale_, FVector(1.0, 1.0, 1.0));
}   

FTransform AUrdfBotPawn::getRelativePose(const FString& baseLinkName, const FString& TargetlinkName)
{
	const FTransform& World2Base = this->components_[baseLinkName]->GetTransform();
	AUrdfLink* targetLink = this->components_[TargetlinkName];

	FVector base2targetPos = World2Base.InverseTransformPosition(targetLink->GetActorLocation());
	FQuat base2targetOri = World2Base.InverseTransformRotation(targetLink->GetActorRotation().Quaternion());

	//URobotBlueprintLib::LogMessage(baseLinkName + FString("actual: \n"), *World2Base.ToHumanReadableString(), LogDebugLevel::Informational, 30);
	//URobotBlueprintLib::LogMessage(TargetlinkName + FString("actual: \n"), *targetLink->GetTransform().ToHumanReadableString(), LogDebugLevel::Informational, 30);

	return FTransform(base2targetOri, base2targetPos / this->world_scale_, FVector(1.0, 1.0, 1.0));
}

TMap<FString, float> AUrdfBotPawn::GetTargetQPosByLinkName()
{
	TMap<FString, float> map;
	for (const TPair<FString, ControlledMotionComponent*>& pair : this->controlled_motion_components_)
	{
		map.Add(pair.Value->GetActuatorLink()->linkName_, pair.Value->GetDriveTarget());
	}
	return map;
}
...
TMap<FString, float> AUrdfBotPawn::GetCurrentQPosByLinkName()
{
	...
	{
		ControlledMotionComponent* component = this->controlled_motion_components_[str];
		FTransform transform = getJointPose(str);
		//URobotBlueprintLib::LogMessage(str, FString::SanitizeFloat(180 / PI * component->GetDriveTarget()) + FString(" -> ") + transform.GetTranslation().ToString() + FString(" ") + transform.GetRotation().Euler().ToString(), LogDebugLevel::Informational, 30);
		URobotBlueprintLib::LogMessage(str, FString::SanitizeFloat(180 / PI * component->GetDriveTarget()) + FString(" -> ") + transform.GetRotation().Euler().ToString(), LogDebugLevel::Informational, 30);

	}
	for (const TPair<FString, ControlledMotionComponent*>& pair : this->controlled_motion_components_)
	{
		//FTransform transform = getJointPose(pair.Key);	
		//URobotBlueprintLib::LogMessage(pair.Key, FString::SanitizeFloat(180 / PI * pair.Value->GetDriveTarget())+FString(" -> ")+transform.GetTranslation().ToString() + FString(" ") + transform.GetRotation().Euler().ToString() , LogDebugLevel::Informational, 30);
...
void AUrdfBotPawn::SetTargetQPosByLinkName(const TMap<FString, float>& map)
{
	for (const TPair<FString, float>& pair : map)
	{
		if (this->components_.Contains(pair.Key))
		{
			...
			this->controlled_motion_components_[jointName]->SetDriveTarget(pair.Value);
		}
	}
}
...
void AUrdfBotPawn::SetTargetQPos(const TMap<FString, float>& map)
{
	for (const TPair<FString, float>& pair : map)
	{
		...
		{
			ControlledMotionComponent* jointComponent = this->controlled_motion_components_[pair.Key];
