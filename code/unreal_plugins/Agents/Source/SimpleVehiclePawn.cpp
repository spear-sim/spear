...
ASimpleVehiclePawn::ASimpleVehiclePawn(const FObjectInitializer& ObjectInitializer) : APawn(ObjectInitializer)
{
    ...
    // Setup skeletal mesh
    static ConstructorHelpers::FObjectFinder<USkeletalMesh> CarMesh(TEXT("/Agents/SimpleVehicle/OpenBot/OpenBot.OpenBot"));
    Mesh->SetSkeletalMesh(CarMesh.Object);

    // Setup animation
    static ConstructorHelpers::FClassFinder<UAnimInstance> finderAnim(TEXT("/Agents/SimpleVehicle/OpenBot/OpenBot_Animation.OpenBot_Animation_C"));
