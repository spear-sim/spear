...
class AGENTS_API AOpenBotPawn : public APawn
{
    GENERATED_BODY()
...
public:
    /**
     * @brief Construct a new AOpenBotPawn object
     *
     * @param ObjectInitializer
     */
    AOpenBotPawn(const FObjectInitializer& ObjectInitializer);

    /**
     * @brief Destroy the AOpenBotPawn object
     *
     */
     ...
     * @param teleport
     */
    void TeleportToLocation(FVector position,
                                    FQuat orientation,
                                    bool teleport);
