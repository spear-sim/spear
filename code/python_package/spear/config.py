...
DEFAULT_CONFIG_FILES = [
    os.path.realpath(os.path.join(SPEAR_ROOT_DIR, "default_config.openbot.yaml"))
    os.path.realpath(os.path.join(SPEAR_ROOT_DIR, "default_config.simulation_controller.yaml"))
    os.path.realpath(os.path.join(SPEAR_ROOT_DIR, "default_config.spear.yaml")) ]
