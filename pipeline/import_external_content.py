...
if __name__ == "__main__":
    ...
    source_unreal_project_source_content_filesystem_path = spear.utils.pipeline_utils.get_filesystem_path_from_content_path(
    ...
    temp_unreal_project_source_content_filesystem_path = spear.utils.pipeline_utils.get_filesystem_path_from_content_path(
        content_path=args.source_content_path,
        unreal_project_dir=temp_unreal_project_dir,
        unreal_engine_dir=args.unreal_engine_dir)

    temp_unreal_project_destination_content_filesystem_path = spear.utils.pipeline_utils.get_filesystem_path_from_content_path(
        content_path=args.destination_content_path,
        unreal_project_dir=temp_unreal_project_dir,
        unreal_engine_dir=args.unreal_engine_dir)

    destination_unreal_project_destination_content_filesystem_path = spear.utils.pipeline_utils.get_filesystem_path_from_content_path(
        content_path=args.destination_content_path,
