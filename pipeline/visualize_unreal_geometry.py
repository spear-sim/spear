...
def draw_actor(actor_desc, color):
    ...
    draw_component(
        transform_world_from_parent_component=spear.pipeline_utils.identity_transform,
...
def draw_component(transform_world_from_parent_component, component_desc, color, log_prefix_str):
    ...
    if component_class in scene_component_classes:
        ...
        transform_world_from_current_component = spear.pipeline_utils.compose_transform_with_component(
        ...
        debug_info_world_transform = spear.pipeline_utils.get_matrix_from_matrix_desc(matrix_desc=component_desc["debug_info"]["world_transform"])
