...
from my_habitat_baselines.rnn_state_encoder import RNNStateEncoder
...
class ResNetEncoder(nn.Module):
    def __init__(
        ...
        self._norm_vis_inputs = normalize_visual_inputs
        ...
        if not self.is_blind:
            ...
            self.final_fc = nn.Sequential(
                nn.Linear(
                    num_compression_channels * (final_spatial ** 2),
                    flat_output_size,
                ),
                nn.ReLU(True),
            )
