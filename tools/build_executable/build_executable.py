...
if __name__ == "__main__":
    ...
    parser.add_argument("--paks_version", required=True)
    ...
    pak_file_src  = os.path.realpath(os.path.join(args.paks_dir, "kujiale_0000-" + args.paks_version + "-" + pak_platform + ".pak"))
    pak_file_dest = os.path.realpath(os.path.join(paks_dir_dest, "kujiale_0000-" + args.paks_version + "-" + pak_platform + ".pak"))
