...
class FuncSignatureRegistry
{
    ...
    /* 10 */ template <> int getTypeId<std::vector<StaticStructDesc>>                         () { return 10; }
    ...
    /* 13 */ template <> int getTypeId<std::map<std::string, std::vector<FuncSignatureDesc>>> () { return 13; }
    /* 14 */ template <> int getTypeId<std::map<std::string, PropertyValue>>                  () { return 14; }
    /* 15 */ template <> int getTypeId<std::map<std::string, SharedMemoryView>>               () { return 15; }
    /* 16 */ template <> int getTypeId<std::map<std::string, PackedArray>>                    () { return 16; }
    /* 17 */ template <> int getTypeId<std::map<std::string, WorldDesc>>                      () { return 17; }
    /* 18 */ template <> int getTypeId<PropertyDesc>                                          () { return 18; }
    /* 19 */ template <> int getTypeId<PropertyValue>                                         () { return 19; }
    /* 20 */ template <> int getTypeId<SharedMemoryView>                                      () { return 20; }
    /* 21 */ template <> int getTypeId<PackedArray>                                           () { return 21; }
    /* 22 */ template <> int getTypeId<DataBundle>                                            () { return 22; }
    /* 23 */ template <> int getTypeId<Future>                                                () { return 23; }
    /* 24 */ template <> int getTypeId<StaticStructDesc>                                      () { return 24; }
    /* 25 */ template <> int getTypeId<WorldDesc>                                             () { return 25; }
...
public:
    ...
    /* 10 */ template <> std::vector<StaticStructDesc>                         getReturnValue<std::vector<StaticStructDesc>>                         (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::vector<StaticStructDesc>>                                              (client, std::move(object_handle)); }
    /* 11 */ template <> std::map<std::string, uint64_t>                       getReturnValue<std::map<std::string, uint64_t>>                       (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, uint64_t>>                                            (client, std::move(object_handle)); }
    /* 12 */ template <> std::map<std::string, std::string>                    getReturnValue<std::map<std::string, std::string>>                    (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, std::string>>                                         (client, std::move(object_handle)); }
    /* 13 */ template <> std::map<std::string, std::vector<FuncSignatureDesc>> getReturnValue<std::map<std::string, std::vector<FuncSignatureDesc>>> (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, std::vector<FuncSignatureDesc>>>                      (client, std::move(object_handle)); }
    /* 14 */ template <> std::map<std::string, PropertyValue>                  getReturnValue<std::map<std::string, PropertyValue>>                  (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, PropertyValue>>                                       (client, std::move(object_handle)); }
    /* 15 */ template <> std::map<std::string, SharedMemoryView>               getReturnValue<std::map<std::string, SharedMemoryView>>               (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, SharedMemoryView>>                                    (client, std::move(object_handle)); }
    /* 16 */ template <> std::map<std::string, PackedArray>                    getReturnValue<std::map<std::string, PackedArray>>                    (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, PackedArray>, std::map<std::string, PackedArrayView>> (client, std::move(object_handle)); }
    /* 17 */ template <> std::map<std::string, WorldDesc>                      getReturnValue<std::map<std::string, WorldDesc>>                      (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, WorldDesc>>                                           (client, std::move(object_handle)); }
    /* 18 */ template <> PropertyDesc                                          getReturnValue<PropertyDesc>                                          (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<PropertyDesc>                                                               (client, std::move(object_handle)); }
    /* 19 */ template <> PropertyValue                                         getReturnValue<PropertyValue>                                         (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<PropertyValue>                                                              (client, std::move(object_handle)); }
    /* 20 */ template <> SharedMemoryView                                      getReturnValue<SharedMemoryView>                                      (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<SharedMemoryView>                                                           (client, std::move(object_handle)); }
    /* 21 */ template <> PackedArray                                           getReturnValue<PackedArray>                                           (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<PackedArray, PackedArrayView>                                               (client, std::move(object_handle)); }
    /* 22 */ template <> DataBundle                                            getReturnValue<DataBundle>                                            (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<DataBundle, DataBundleView>                                                 (client, std::move(object_handle)); }
    /* 23 */ template <> Future                                                getReturnValue<Future>                                                (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<Future>                                                                     (client, std::move(object_handle)); }
    /* 24 */ template <> StaticStructDesc                                      getReturnValue<StaticStructDesc>                                      (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<StaticStructDesc>                                                           (client, std::move(object_handle)); }
    /* 25 */ template <> WorldDesc                                             getReturnValue<WorldDesc>                                             (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<WorldDesc>                                                                  (client, std::move(object_handle)); }
...
private:
    inline static std::vector<FuncSignatureTypeDesc> s_func_signature_type_descs_ = {
        ...
        /* 13 */ getTypeDesc({{"python_ext", "std::map<std::string, std::vector<FuncSignatureTypeDesc>>"}, {"entry_point", "map_of_string_to_vector_of_func_signature_desc"}}, {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 14 */ getTypeDesc({{"python_ext", "std::map<std::string, PropertyValue>"},                      {"entry_point", "map_of_string_to_property_value"}},                {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 15 */ getTypeDesc({{"python_ext", "std::map<std::string, SharedMemoryView>"},                   {"entry_point", "map_of_string_to_shared_memory_view"}},            {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 16 */ getTypeDesc({{"python_ext", "std::map<std::string, PackedArray>"},                        {"entry_point", "map_of_string_to_packed_array"}},                  {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 17 */ getTypeDesc({{"python_ext", "std::map<std::string, WorldDesc>"},                          {"entry_point", "map_of_string_to_world_desc"}},                    {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 18 */ getTypeDesc({{"python_ext", "PropertyDesc"},                                              {"entry_point", "property_desc"}},                                  {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 19 */ getTypeDesc({{"python_ext", "PropertyValue"},                                             {"entry_point", "property_value"}},                                 {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 20 */ getTypeDesc({{"python_ext", "SharedMemoryView"},                                          {"entry_point", "shared_memory_view"}},                             {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 21 */ getTypeDesc({{"python_ext", "PackedArray"},                                               {"entry_point", "packed_array"}},                                   {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 22 */ getTypeDesc({{"python_ext", "DataBundle"},                                                {"entry_point", "data_bundle"}},                                    {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 23 */ getTypeDesc({{"python_ext", "Future"},                                                    {"entry_point", "future"}},                                         {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 24 */ getTypeDesc({{"python_ext", "StaticStructDesc"},                                          {"entry_point", "static_struct_desc"}},                             {{"python_ext", "const "}}, {{"python_ext", "&"}}),
        /* 25 */ getTypeDesc({{"python_ext", "WorldDesc"},                                                 {"entry_point", "world_desc"}},                                     {{"python_ext", "const "}}, {{"python_ext", "&"}})};
