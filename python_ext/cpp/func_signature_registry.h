...
class FuncSignatureRegistry
{
    ...
    /* 13 */ template <> int getTypeId<std::map<std::string, PropertyValue>>                  () { return 13; }
    /* 14 */ template <> int getTypeId<std::map<std::string, SharedMemoryView>>               () { return 14; }
    /* 15 */ template <> int getTypeId<std::map<std::string, PackedArray>>                    () { return 15; }
    /* 16 */ template <> int getTypeId<std::map<std::string, std::vector<FuncSignatureDesc>>> () { return 16; }
    /* 17 */ template <> int getTypeId<PropertyDesc>                                          () { return 17; }
    /* 18 */ template <> int getTypeId<PropertyValue>                                         () { return 18; }
    /* 19 */ template <> int getTypeId<SharedMemoryView>                                      () { return 19; }
    /* 20 */ template <> int getTypeId<PackedArray>                                           () { return 20; }
    /* 21 */ template <> int getTypeId<DataBundle>                                            () { return 21; }
    /* 22 */ template <> int getTypeId<Future>                                                () { return 22; }
    /* 23 */ template <> int getTypeId<StaticStructDesc>                                      () { return 23; }
...
public:
    ...
    /* 13 */ template <> std::map<std::string, PropertyValue>                  getReturnValue<std::map<std::string, PropertyValue>>                  (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, PropertyValue>>                                       (client, std::move(object_handle)); }
    /* 14 */ template <> std::map<std::string, SharedMemoryView>               getReturnValue<std::map<std::string, SharedMemoryView>>               (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, SharedMemoryView>>                                    (client, std::move(object_handle)); }
    /* 15 */ template <> std::map<std::string, PackedArray>                    getReturnValue<std::map<std::string, PackedArray>>                    (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, PackedArray>, std::map<std::string, PackedArrayView>> (client, std::move(object_handle)); }
    /* 16 */ template <> std::map<std::string, std::vector<FuncSignatureDesc>> getReturnValue<std::map<std::string, std::vector<FuncSignatureDesc>>> (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<std::map<std::string, std::vector<FuncSignatureDesc>>>                      (client, std::move(object_handle)); }
    /* 17 */ template <> PropertyDesc                                          getReturnValue<PropertyDesc>                                          (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<PropertyDesc>                                                               (client, std::move(object_handle)); }
    /* 18 */ template <> PropertyValue                                         getReturnValue<PropertyValue>                                         (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<PropertyValue>                                                              (client, std::move(object_handle)); }
    /* 19 */ template <> SharedMemoryView                                      getReturnValue<SharedMemoryView>                                      (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<SharedMemoryView>                                                           (client, std::move(object_handle)); }
    /* 20 */ template <> PackedArray                                           getReturnValue<PackedArray>                                           (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<PackedArray, PackedArrayView>                                               (client, std::move(object_handle)); }
    /* 21 */ template <> DataBundle                                            getReturnValue<DataBundle>                                            (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<DataBundle, DataBundleView>                                                 (client, std::move(object_handle)); }
    /* 22 */ template <> Future                                                getReturnValue<Future>                                                (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<Future>                                                                     (client, std::move(object_handle)); }
    /* 23 */ template <> StaticStructDesc                                      getReturnValue<StaticStructDesc>                                      (const Client* client, clmdep_msgpack::object_handle&& object_handle) { return getReturnValueImpl<StaticStructDesc>                                                           (client, std::move(object_handle)); }
