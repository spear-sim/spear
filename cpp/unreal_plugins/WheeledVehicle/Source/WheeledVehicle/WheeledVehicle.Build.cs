...
public class WheeledVehicle : ModuleRules
{
    public WheeledVehicle(ReadOnlyTargetRules Target) : base(Target)
    {
        Console.WriteLine("[SPEAR | WheeledVehicle.Build.cs] WheeledVehicle::WheeledVehicle");
        ...
        Console.WriteLine("[SPEAR | WheeledVehicle.Build.cs] Resolved top-level module directory: " + topLevelModuleDir);
        ...
        Console.WriteLine("[SPEAR | WheeledVehicle.Build.cs] Resolved third-party directory: " + thirdPartyDir);
        ...
        if (Target.Platform == UnrealTargetPlatform.Win64) {
            ...
            throw new Exception("[SPEAR | WheeledVehicle.Build.cs] Unexpected target platform: " + Target.Platform);
        }
    }
}
