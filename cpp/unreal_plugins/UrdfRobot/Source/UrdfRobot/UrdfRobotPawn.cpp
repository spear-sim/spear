...
AUrdfRobotPawn::AUrdfRobotPawn(const FObjectInitializer& object_initializer) : APawn(object_initializer)
{
    ...
    UrdfRobotDesc robot_desc = UrdfParser::parse(Unreal::toStdString(FPaths::Combine(
        Unreal::toFString(Config::get<std::string>("URDF_ROBOT.URDF_ROBOT_PAWN.URDF_DIR")),
        Unreal::toFString(Config::get<std::string>("URDF_ROBOT.URDF_ROBOT_PAWN.URDF_FILE")))));

    urdf_robot_component_ = CreateDefaultSubobject<UUrdfRobotComponent>(TEXT("urdf_robot_component"));
    ...
    FVector camera_location(
        Config::get<float>("URDF_ROBOT.URDF_ROBOT_PAWN.CAMERA_COMPONENT.LOCATION_X"),
        Config::get<float>("URDF_ROBOT.URDF_ROBOT_PAWN.CAMERA_COMPONENT.LOCATION_Y"),
        Config::get<float>("URDF_ROBOT.URDF_ROBOT_PAWN.CAMERA_COMPONENT.LOCATION_Z"));

    FRotator camera_orientation(
        Config::get<float>("URDF_ROBOT.URDF_ROBOT_PAWN.CAMERA_COMPONENT.ROTATION_PITCH"),
        Config::get<float>("URDF_ROBOT.URDF_ROBOT_PAWN.CAMERA_COMPONENT.ROTATION_YAW"),
        Config::get<float>("URDF_ROBOT.URDF_ROBOT_PAWN.CAMERA_COMPONENT.ROTATION_ROLL"));
...
void AUrdfRobotPawn::SetupPlayerInputComponent(UInputComponent* input_component)
{
    ...
    auto keyboard_actions = Config::get<std::map<std::string, std::map<std::string, std::map<std::string, float>>>>("URDF_ROBOT.URDF_ROBOT_PAWN.KEYBOARD_ACTIONS");
