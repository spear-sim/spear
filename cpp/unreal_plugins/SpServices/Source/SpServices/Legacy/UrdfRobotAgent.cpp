...
UrdfRobotAgent::UrdfRobotAgent(UWorld* world)
{
    ...
    std::string spawn_mode = Config::get<std::string>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.SPAWN_MODE");
    if (spawn_mode == "specify_existing_actor") {
        AActor* spawn_actor = Unreal::findActorByName(world, Config::get<std::string>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.SPAWN_ACTOR_NAME"));
        ...
        spawn_location = FVector(
            Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.SPAWN_LOCATION_X"),
            Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.SPAWN_LOCATION_Y"),
            Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.SPAWN_LOCATION_Z"));
        spawn_rotation = FRotator(
            Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.SPAWN_ROTATION_PITCH"),
            Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.SPAWN_ROTATION_YAW"),
            Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.SPAWN_ROTATION_ROLL"));
    } else {
        SP_ASSERT(false);
    }
    FActorSpawnParameters actor_spawn_params;
    actor_spawn_params.Name = Unreal::toFName(Config::get<std::string>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.URDF_ROBOT_ACTOR_NAME"));
    ...
    urdf_robot_pawn_->CameraComponent->FieldOfView =
        Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.CAMERA.FOV");
    urdf_robot_pawn_->CameraComponent->AspectRatio =
        Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.CAMERA.IMAGE_WIDTH") /
        Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.CAMERA.IMAGE_HEIGHT");
    ...
    urdf_robot_pawn_->UrdfRobotComponent->setActionComponents(Config::get<std::vector<std::string>>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.ACTION_COMPONENTS"));
    urdf_robot_pawn_->UrdfRobotComponent->setObservationComponents(Config::get<std::vector<std::string>>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.OBSERVATION_COMPONENTS"));

    auto observation_components = Config::get<std::vector<std::string>>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.OBSERVATION_COMPONENTS");

    if (Std::contains(observation_components, "camera")) {
        camera_sensor_ = std::make_unique<CameraSensor>(
            urdf_robot_pawn_->CameraComponent,
            Config::get<std::vector<std::string>>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.CAMERA.RENDER_PASSES"),
            Config::get<unsigned int>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.CAMERA.IMAGE_WIDTH"),
            Config::get<unsigned int>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.CAMERA.IMAGE_HEIGHT"),
            Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.CAMERA.FOV"));
...
bool UrdfRobotAgent::isReady() const
{
    ...
    return sum_vel <= Config::get<float>("SP_SERVICES.LEGACY.URDF_ROBOT_AGENT.IS_READY_VELOCITY_THRESHOLD");
}
