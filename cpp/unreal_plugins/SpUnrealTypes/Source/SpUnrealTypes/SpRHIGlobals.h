...
UENUM()
enum class ESpRHIBindlessSupport
{
...
UENUM()
enum class ESpShaderPlatform
{
    PCD3D_SM5 = Unreal::getConstEnumValue(EShaderPlatform::SP_PCD3D_SM5),
    METAL = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL),
    METAL_MRT = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_MRT),
    PCD3D_ES3_1 = Unreal::getConstEnumValue(EShaderPlatform::SP_PCD3D_ES3_1),
    OPENGL_PCES3_1 = Unreal::getConstEnumValue(EShaderPlatform::SP_OPENGL_PCES3_1),
    METAL_SM5 = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_SM5),
    VULKAN_PCES3_1 = Unreal::getConstEnumValue(EShaderPlatform::SP_VULKAN_PCES3_1),
    VULKAN_SM5 = Unreal::getConstEnumValue(EShaderPlatform::SP_VULKAN_SM5),
    VULKAN_ES3_1_ANDROID = Unreal::getConstEnumValue(EShaderPlatform::SP_VULKAN_ES3_1_ANDROID),
    METAL_MACES3_1 = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_MACES3_1),
    OPENGL_ES3_1_ANDROID = Unreal::getConstEnumValue(EShaderPlatform::SP_OPENGL_ES3_1_ANDROID),
    METAL_MRT_MAC = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_MRT_MAC),
    METAL_TVOS = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_TVOS),
    METAL_MRT_TVOS = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_MRT_TVOS),
    StaticPlatform_First = Unreal::getConstEnumValue(EShaderPlatform::SP_StaticPlatform_First),
    StaticPlatform_Last = Unreal::getConstEnumValue(EShaderPlatform::SP_StaticPlatform_Last),
    VULKAN_SM5_ANDROID = Unreal::getConstEnumValue(EShaderPlatform::SP_VULKAN_SM5_ANDROID),
    PCD3D_SM6 = Unreal::getConstEnumValue(EShaderPlatform::SP_PCD3D_SM6),
    VULKAN_SM6 = Unreal::getConstEnumValue(EShaderPlatform::SP_VULKAN_SM6),
    METAL_SM6 = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_SM6),
    METAL_SIM = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_SIM),
    CUSTOM_PLATFORM_FIRST = Unreal::getConstEnumValue(EShaderPlatform::SP_CUSTOM_PLATFORM_FIRST),
    CUSTOM_PLATFORM_LAST = Unreal::getConstEnumValue(EShaderPlatform::SP_CUSTOM_PLATFORM_LAST),
    NumPlatforms = Unreal::getConstEnumValue(EShaderPlatform::SP_NumPlatforms),
    NumBits = Unreal::getConstEnumValue(EShaderPlatform::SP_NumBits),
};

UENUM()
enum class ESpVRSImageDataType
{
    NotSupported = Unreal::getConstEnumValue(EVRSImageDataType::VRSImage_NotSupported),
    Palette = Unreal::getConstEnumValue(EVRSImageDataType::VRSImage_Palette),
    Fractional = Unreal::getConstEnumValue(EVRSImageDataType::VRSImage_Fractional),
};

UENUM()
enum class ESpPixelFormat
{
    Unknown = Unreal::getConstEnumValue(EPixelFormat::PF_Unknown),
    A32B32G32R32F = Unreal::getConstEnumValue(EPixelFormat::PF_A32B32G32R32F),
    B8G8R8A8 = Unreal::getConstEnumValue(EPixelFormat::PF_B8G8R8A8),
    G8 = Unreal::getConstEnumValue(EPixelFormat::PF_G8),
    G16 = Unreal::getConstEnumValue(EPixelFormat::PF_G16),
    DXT1 = Unreal::getConstEnumValue(EPixelFormat::PF_DXT1),
    DXT3 = Unreal::getConstEnumValue(EPixelFormat::PF_DXT3),
    DXT5 = Unreal::getConstEnumValue(EPixelFormat::PF_DXT5),
    UYVY = Unreal::getConstEnumValue(EPixelFormat::PF_UYVY),
    FloatRGB = Unreal::getConstEnumValue(EPixelFormat::PF_FloatRGB),
    FloatRGBA = Unreal::getConstEnumValue(EPixelFormat::PF_FloatRGBA),
    DepthStencil = Unreal::getConstEnumValue(EPixelFormat::PF_DepthStencil),
    ShadowDepth = Unreal::getConstEnumValue(EPixelFormat::PF_ShadowDepth),
    R32_FLOAT = Unreal::getConstEnumValue(EPixelFormat::PF_R32_FLOAT),
    G16R16 = Unreal::getConstEnumValue(EPixelFormat::PF_G16R16),
    G16R16F = Unreal::getConstEnumValue(EPixelFormat::PF_G16R16F),
    G16R16F_FILTER = Unreal::getConstEnumValue(EPixelFormat::PF_G16R16F_FILTER),
    G32R32F = Unreal::getConstEnumValue(EPixelFormat::PF_G32R32F),
    A2B10G10R10 = Unreal::getConstEnumValue(EPixelFormat::PF_A2B10G10R10),
    A16B16G16R16 = Unreal::getConstEnumValue(EPixelFormat::PF_A16B16G16R16),
    D24 = Unreal::getConstEnumValue(EPixelFormat::PF_D24),
    R16F = Unreal::getConstEnumValue(EPixelFormat::PF_R16F),
    R16F_FILTER = Unreal::getConstEnumValue(EPixelFormat::PF_R16F_FILTER),
    BC5 = Unreal::getConstEnumValue(EPixelFormat::PF_BC5),
    V8U8 = Unreal::getConstEnumValue(EPixelFormat::PF_V8U8),
    A1 = Unreal::getConstEnumValue(EPixelFormat::PF_A1),
    FloatR11G11B10 = Unreal::getConstEnumValue(EPixelFormat::PF_FloatR11G11B10),
    A8 = Unreal::getConstEnumValue(EPixelFormat::PF_A8),
    R32_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R32_UINT),
    R32_SINT = Unreal::getConstEnumValue(EPixelFormat::PF_R32_SINT),
    PVRTC2 = Unreal::getConstEnumValue(EPixelFormat::PF_PVRTC2),
    PVRTC4 = Unreal::getConstEnumValue(EPixelFormat::PF_PVRTC4),
    R16_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R16_UINT),
    R16_SINT = Unreal::getConstEnumValue(EPixelFormat::PF_R16_SINT),
    R16G16B16A16_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R16G16B16A16_UINT),
    R16G16B16A16_SINT = Unreal::getConstEnumValue(EPixelFormat::PF_R16G16B16A16_SINT),
    R5G6B5_UNORM = Unreal::getConstEnumValue(EPixelFormat::PF_R5G6B5_UNORM),
    R8G8B8A8 = Unreal::getConstEnumValue(EPixelFormat::PF_R8G8B8A8),
    A8R8G8B8 = Unreal::getConstEnumValue(EPixelFormat::PF_A8R8G8B8),
    BC4 = Unreal::getConstEnumValue(EPixelFormat::PF_BC4),
    R8G8 = Unreal::getConstEnumValue(EPixelFormat::PF_R8G8),
    ATC_RGB = Unreal::getConstEnumValue(EPixelFormat::PF_ATC_RGB),
    ATC_RGBA_E = Unreal::getConstEnumValue(EPixelFormat::PF_ATC_RGBA_E),
    ATC_RGBA_I = Unreal::getConstEnumValue(EPixelFormat::PF_ATC_RGBA_I),
    X24_G8 = Unreal::getConstEnumValue(EPixelFormat::PF_X24_G8),
    ETC1 = Unreal::getConstEnumValue(EPixelFormat::PF_ETC1),
    ETC2_RGB = Unreal::getConstEnumValue(EPixelFormat::PF_ETC2_RGB),
    ETC2_RGBA = Unreal::getConstEnumValue(EPixelFormat::PF_ETC2_RGBA),
    R32G32B32A32_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R32G32B32A32_UINT),
    R16G16_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R16G16_UINT),
    ASTC_4x4 = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_4x4),
    ASTC_6x6 = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_6x6),
    ASTC_8x8 = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_8x8),
    ASTC_10x10 = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_10x10),
    ASTC_12x12 = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_12x12),
    BC6H = Unreal::getConstEnumValue(EPixelFormat::PF_BC6H),
    BC7 = Unreal::getConstEnumValue(EPixelFormat::PF_BC7),
    R8_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R8_UINT),
    L8 = Unreal::getConstEnumValue(EPixelFormat::PF_L8),
    XGXR8 = Unreal::getConstEnumValue(EPixelFormat::PF_XGXR8),
    R8G8B8A8_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R8G8B8A8_UINT),
    R8G8B8A8_SNORM = Unreal::getConstEnumValue(EPixelFormat::PF_R8G8B8A8_SNORM),
    R16G16B16A16_UNORM = Unreal::getConstEnumValue(EPixelFormat::PF_R16G16B16A16_UNORM),
    R16G16B16A16_SNORM = Unreal::getConstEnumValue(EPixelFormat::PF_R16G16B16A16_SNORM),
    PLATFORM_HDR_0 = Unreal::getConstEnumValue(EPixelFormat::PF_PLATFORM_HDR_0),
    PLATFORM_HDR_1 = Unreal::getConstEnumValue(EPixelFormat::PF_PLATFORM_HDR_1),
    PLATFORM_HDR_2 = Unreal::getConstEnumValue(EPixelFormat::PF_PLATFORM_HDR_2),
    NV12 = Unreal::getConstEnumValue(EPixelFormat::PF_NV12),
    R32G32_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R32G32_UINT),
    ETC2_R11_EAC = Unreal::getConstEnumValue(EPixelFormat::PF_ETC2_R11_EAC),
    ETC2_RG11_EAC = Unreal::getConstEnumValue(EPixelFormat::PF_ETC2_RG11_EAC),
    R8 = Unreal::getConstEnumValue(EPixelFormat::PF_R8),
    B5G5R5A1_UNORM = Unreal::getConstEnumValue(EPixelFormat::PF_B5G5R5A1_UNORM),
    ASTC_4x4_HDR = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_4x4_HDR),	
    ASTC_6x6_HDR = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_6x6_HDR),	
    ASTC_8x8_HDR = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_8x8_HDR),	
    ASTC_10x10_HDR = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_10x10_HDR),	
    ASTC_12x12_HDR = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_12x12_HDR),
    G16R16_SNORM = Unreal::getConstEnumValue(EPixelFormat::PF_G16R16_SNORM),
    R8G8_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R8G8_UINT),
    R32G32B32_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R32G32B32_UINT),
    R32G32B32_SINT = Unreal::getConstEnumValue(EPixelFormat::PF_R32G32B32_SINT),
    R32G32B32F = Unreal::getConstEnumValue(EPixelFormat::PF_R32G32B32F),
    R8_SINT = Unreal::getConstEnumValue(EPixelFormat::PF_R8_SINT),
    R64_UINT = Unreal::getConstEnumValue(EPixelFormat::PF_R64_UINT),
    R9G9B9EXP5 = Unreal::getConstEnumValue(EPixelFormat::PF_R9G9B9EXP5),
    P010 = Unreal::getConstEnumValue(EPixelFormat::PF_P010),
    ASTC_4x4_NORM_RG = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_4x4_NORM_RG),
    ASTC_6x6_NORM_RG = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_6x6_NORM_RG),
    ASTC_8x8_NORM_RG = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_8x8_NORM_RG),
    ASTC_10x10_NORM_RG = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_10x10_NORM_RG),
    ASTC_12x12_NORM_RG = Unreal::getConstEnumValue(EPixelFormat::PF_ASTC_12x12_NORM_RG),
    R16G16_SINT = Unreal::getConstEnumValue(EPixelFormat::PF_R16G16_SINT),
