...
#include <RHIDefinitions.h>       // ERequestedGPUCrash, EVRSImageDataType, MAX_TEXTURE_MIP_COUNT
...
// UENUM(BlueprintType) // deprecated in UE 5.7
...
enum class ESpShaderPlatform : uint16
{
    ...
    SP_METAL_ES3_1_IOS      = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_ES3_1_IOS),
    SP_METAL_SM5_IOS        = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_SM5_IOS),
    ...
    SP_METAL_ES3_1          = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_ES3_1),
    SP_OPENGL_ES3_1_ANDROID = Unreal::getConstEnumValue(EShaderPlatform::SP_OPENGL_ES3_1_ANDROID),
    SP_METAL_ES3_1_TVOS     = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_ES3_1_TVOS),
    SP_METAL_SM5_TVOS       = Unreal::getConstEnumValue(EShaderPlatform::SP_METAL_SM5_TVOS),
    ...
    SP_VULKAN_SM5_ANDROID = Unreal::getConstEnumValue(SP_VULKAN_SM5_ANDROID),
    SP_PCD3D_SM6          = Unreal::getConstEnumValue(SP_PCD3D_SM6),
    SP_VULKAN_SM6         = Unreal::getConstEnumValue(SP_VULKAN_SM6),
    SP_METAL_SM6          = Unreal::getConstEnumValue(SP_METAL_SM6),
    SP_METAL_SIM          = Unreal::getConstEnumValue(SP_METAL_SIM),
    SP_METAL_SM6_IOS      = Unreal::getConstEnumValue(SP_METAL_SM6_IOS),

    SP_CUSTOM_PLATFORM_FIRST = Unreal::getConstEnumValue(SP_CUSTOM_PLATFORM_FIRST),
    SP_CUSTOM_PLATFORM_LAST  = Unreal::getConstEnumValue(SP_CUSTOM_PLATFORM_LAST),

    SP_NumPlatforms = Unreal::getConstEnumValue(SP_NumPlatforms),
    SP_NumBits      = Unreal::getConstEnumValue(SP_NumBits)
};
...
struct FSpRHIGlobals
{
    ...
    */
    ...
    // UPROPERTY()
    // ESpRHIBindlessSupport BindlessSupport = ESpRHIBindlessSupport::Unsupported; deprecated in UE 5.7
...
public:
    ...
    static FSpRHIGlobals GetRHIGlobals()
    {
        ...
        // result.BindlessSupport =                                     Unreal::getEnumValueAs<ESpRHIBindlessSupport>(GRHIGlobals.BindlessSupport); // deprecated in UE 5.7
