...
public:
    ...
    public:
        ...
        UpdateArrayDataPtrScope(TArray<TValue>& array, void* data_ptr, uint64_t num_bytes) : array_(array)
        {
            ...
            array_data_ptr_ = updateArrayDataPtrImpl(array_, data_ptr, num_bytes_);
        };

        ~UpdateArrayDataPtrScope()
        {
            updateArrayDataPtrImpl(array_, array_data_ptr_, num_bytes_);
        };
...
private:
    ...
    template <typename TValue>
    static TValue* updateArrayDataPtrImpl(TArray<TValue>& array, void* data_ptr, uint64_t num_bytes)
    {
