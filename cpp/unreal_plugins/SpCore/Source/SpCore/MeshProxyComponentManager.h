...
public:
    ...
    void initialize()
    {
        emissive_material_ = TStrongObjectPtr<UMaterialInterface>(LoadObject<UMaterialInterface>(nullptr, Unreal::toFString("/SpContent/Materials/M_Emissive.M_Emissive")));
...
public:
    ...
    void initialize()
    {
        diffuse_material_ = TStrongObjectPtr<UMaterialInterface>(LoadObject<UMaterialInterface>(nullptr, Unreal::toFString("/SpContent/Materials/M_Diffuse.M_Diffuse")));
