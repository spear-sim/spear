...
The SPEAR code is licensed under is licensed under an [MIT License](http://opensource.org/licenses/MIT), and the SPEAR assets are licensed under a permissive license that permits academic use. See [here](LICENSE.txt) and [here](LICENSE_ASSETS.txt) for details.
