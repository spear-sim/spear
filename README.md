...
_Figure: By calling existing Unreal functions available through SPEAR, it is straightforward to control the lighting in any scene. In the image above, we programmatically control the lighting to simulate time-of-day changes in the `ElectricDreams` sample project available from Epic Games._
