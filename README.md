...
The code and assets in this repository are released under an [MIT License](LICENSE.txt) and [CC0 License](http://creativecommons.org/publicdomain/zero/1.0) respectively.
