...
The SPEAR code is released under an [MIT License](LICENSE.txt), and the SPEAR assets in this repository are released under a [CC0 License](http://creativecommons.org/publicdomain/zero/1.0).
